...
def get_vectorization_size(node):
    ...
    if l == []:
        ...
        raise ValueError(
            "Node {} has mulitple vectorized nodes with different number of nodes. \
...
class Infer(Node, ABC):
    ...
    def init(self, c, n):
        ...
        return {"proba": proba, "particles": vector_c_init, "key": key}
    ...
    def get_particles_number(self):
        raise NotImplementedError(
            "Abstract method get_particles_number not implemented."
        )
